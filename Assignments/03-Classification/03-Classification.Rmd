...
heart <- read_csv(here::here("Assignments", "data", "heart.csv"))

h_splits <- initial_split(heart, prop = 0.9)

h_splits %>%
  training() %>%
  write_csv(here::here("Assignments", "data", "heart_attack.csv"))


h_splits %>%
  testing() %>%
  write_csv(here::here("Assignments", "data", "heart_attack_validation.csv"))
...
Hint: You can specify which metrics you want to calculate in `fit_resamples` function as follows:
